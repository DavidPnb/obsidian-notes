...
- **Propiedades de las Ondas**
	...
	- Las propiedades características de una onda son su altura, su longitud y su frecuencia
	- Otra propiedad importante de las ondas es su velocidad
- **Radiación Electromagnética**
	- Las **ondas electromagnéticas** tienen un componente de campo magnético y un campo eléctrico. Ambas ondas tienen la misma frecuencia, amplitud y longitud
