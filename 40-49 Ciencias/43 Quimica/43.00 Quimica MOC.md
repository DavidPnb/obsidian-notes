...
- Escritura de Ecuaciones
	- Se representan por ecuaciones químicas
		- **Reactivos** - Son los que sufren un cambio y se escriben del lado izquierdo
		- **Productos** - Son las sustancias resultantes y se escribe del lado derecho
	- Se pueden usar las letras *s*, *g* y *l* para representar los estados físicos de las sustancias
