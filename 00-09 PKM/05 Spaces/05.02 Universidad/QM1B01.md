...
## 🎯 Acciones
- [x] ⏳ 2022-11-20 🔼 Trabajo de Química (Ejercicios) ✅ 2022-11-22
- [x] ⏳ 2022-11-24 🔼 Repasar Anexo sobre número de oxidación ✅ 2022-11-29
- [x] ⏳ 2022-11-27 🔼 Transcribir Notas ✅ 2022-11-29
...
- Estequiometría de Reacciones
	...
	- Se cumple la ley de conservación de la masa
		- Los reactantes deben balancearse con los productos
			- Depende de
				- Rendimiento
...
- [x] ⏳ 2022-11-26 🔽 Repasar ✅ 2022-11-27

### Clase 9
- Peso Equivalente
	- Un equivalente de un reactante siempre produce un equivalente de un producto
	- Depende de la reacción en la que esta involucrada la sustancia
	- Ácido Base
		- Ácido
			- (Peso Molecular)/ número de $\ce{ H+ }$
		- Base
			- (Peso Molecular)/ número de $\ce{ (OH)- }$
		- Sal
			- (Peso Molecular)/ número de cationes $\times$ valencia del catión
		- Elemento
			- (Peso Atómico)/Valencia
	- Redox
		- Oxidante
			- (Peso Molecular)/ $+e^{-}$ por fórmula molecular
		- Reductor
			- (Peso Molecular)/ $-e^{-}$ por fórmula molecular

- [x] ⏳ 2022-12-05 🔽 Repasar ✅ 2022-12-05
